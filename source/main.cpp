...
int main(int argc, char** argv) {
	...
	std::string model_file = std::string(PROJECT_SOURCE_DIR) + "/data/assignment3/rect_hole.stl";
	std::string gcode_file_brute_force = std::string(PROJECT_SOURCE_DIR) + "/data/assignment3/results/rect_hole_brute_force.gcode";
	std::string gcode_file = std::string(PROJECT_SOURCE_DIR) + "/data/assignment3/results/rect_hole.gcode";
